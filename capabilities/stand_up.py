...
META = {
    "name": "Stand Up",
    "icon": "⬆",
    "description": "Switch robot to normal (standing) mode.",
}
...
def main():
    if OFFLINE:
        ...
        time.sleep(0.5)
        print("OFFLINE: Selecting normal (stand) mode...")
        time.sleep(0.5)
        print("Done.")
        return
    ...
    print("Selecting normal (stand) mode...")
    resp = node.send(SELECT_MODE, {"name": "normal"})
